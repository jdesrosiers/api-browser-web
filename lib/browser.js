...
const follow = (browser, link) => {
  ...
  return fetch(location.href, { headers: { Accept: accept(browser.acceptable) } })
    .then((response) => {
...
const resolveUrl = (browser, relativeUrl) => new URL(relativeUrl, browser.location.href).href;
